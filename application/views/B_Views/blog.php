    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        <header class="mdl-layout__header mdl-layout__header--waterfall portfolio-header">
            ...
            <div class="mdl-layout__header-row portfolio-navigation-row mdl-layout--large-screen-only">
                <nav class="mdl-navigation mdl-typography--body-1-force-preferred-font">
                    ...
                    <a id="blg" class="mdl-navigation__link is-active" href="">Blog</a>
        ...
        <div class="mdl-layout__drawer mdl-layout--small-screen-only">
            <nav class="mdl-navigation mdl-typography--body-1-force-preferred-font">
                ...
                <a class="mdl-navigation__link is-active" href="<?php echo site_url('Intro/blog');?>">Blog</a>
            ...
            <div class="mdl-grid portfolio-max-width">
                ...
                <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet mdl-card mdl-shadow--4dp">
                    ...
                    <div class="mdl-card__media">
                        <a href="#"> <img class="article-image" src="<?php echo base_url('images/example-blog02.jpg');?>" border="0" alt=""></a>
                    </div>
                ...
                <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet mdl-card mdl-shadow--4dp ">
                    <div class="mdl-card__media">
                        <a href="#"> <img class="article-image" src="<?php echo base_url('images/example-blog04.jpg');?>" border="0" alt=""></a>
                    </div>
                    <div class="mdl-card__supporting-text">
                        <small>Excepteur reprehenderit sint exercitation ipsum consequat qui sit id velit elit.</small>
                    </div>
                    <div class="mdl-card__supporting-text">
                        <p>SHALOM ani ASSAF eiusmod labore sit amet. Voluptate voluptate irure occaecat deserunt incididunt esse in. Qui ullamco consectetur aute fugiat officia ullamco proident Lorem ad irure. Sint eu ut consectetur ut esse veniam.</p>
                    </div>
                </div>
                ...
                <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-card  mdl-card mdl-shadow--4dp portfolio-blog-card-compact">
                    <div class="mdl-card__media">
                        <img class="article-image" src="<?php echo base_url('images/example-blog07.jpg');?>" border="0" alt="">
                    </div>
                    <div class="mdl-card__title ">
